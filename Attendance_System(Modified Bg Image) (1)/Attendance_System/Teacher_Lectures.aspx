<%@ Page Title="" Language="C#" MasterPageFile="~/TeracherMaster.Master" AutoEventWireup="true" CodeBehind="Teacher_Lectures.aspx.cs" Inherits="Attendance_System.Teacher_Lectures" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

<center>
<div style="background-image: url('Images/TakenLecture.jpg'); width: 1200px; height:520px; background-repeat:no-repeat; background-size: cover;">
...
<table align="center" style="width: 1200px; height: 366px">
        ...
        <tr>
            <td colspan="11" align="center">
                <asp:GridView ID="GridView1" runat="server" BackColor="Snow"
