<%@ Page Title="" Language="C#" MasterPageFile="~/TeracherMaster.Master" AutoEventWireup="true" CodeBehind="Mark_Attendance.aspx.cs" Inherits="Attendance_System.Mark_Attendance" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

<center>
<div style="background-image: url('Images/TakingLecture.jpg'); width: 1200px; height:520px; background-repeat:no-repeat; background-size: cover;">
    <center>
