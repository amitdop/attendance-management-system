...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <center>
<div style="background-image: url('Images/teacher.jpg'); width: 1200px; height:auto; background-repeat:no-repeat; background-size: cover;">
    <table align="center" style="height: 340px; width: 392px">
        ...
        <tr>
            <td colspan="2" align="center">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" AllowPaging="True" DataKeyNames="TID" PageSize="5" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TUserID" HeaderText="Email">
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
