    ...
    public partial class Subject : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sda.Fill(ds, "Cousre");
                if(DropDownList1.SelectedItem.Text == "Select Course")
                {
                    Label1.Text = "Plz select Course";
                    Label1.ForeColor = System.Drawing.Color.Red;
                }
                else
                {
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            SqlConnection con1 = new SqlConnection(str);
            con1.Open();
            SqlCommand cmd1 = new SqlCommand("Delete from Subject where SID=@1", con1);

            cmd1.Parameters.AddWithValue("@1", SubjectId);
            cmd1.ExecuteNonQuery();
            con1.Close();
            Label1.Text = "Subject Deleted Successful";
